...
- Name: Loginlogout.spec.js >> Login with HMH Users with right credentials
- Location: tests\Loginlogout.spec.js:21:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://pdm.care.spi-dev.dex.care/departments
Call log:
